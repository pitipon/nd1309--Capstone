...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Only the owner can make this call");
        _;
    }

    //  4) fill out the transferOwnership function
    function _transferOwnership(address newOwner) internal {
        require(newOwner != address(0), "new owner address should be existing");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "address is already owner of this specific token");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _owner || isApprovedForAll(_owner, msg.sender), "Access denied, not allowed to call this approve");
...
contract MyERC721Token is ERC721Metadata("BKK Land Token", "BKKLT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
